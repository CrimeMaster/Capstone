...
function SignUpForm() {
    const [formValues, setFormValues] = useState({check:false, name:"",username:"",mail:"",mobile:""})
        ...
        <div className={styles.body}>
            ...
            <form>
                ...
                <input
                    ...
                    type = 'tel'
                    name = 'mobile'
                    placeholder='Mobile'></input>{mobileError?<p className={styles.error}>Please fill correctly</p>:<></>}
                <label>
                <input
